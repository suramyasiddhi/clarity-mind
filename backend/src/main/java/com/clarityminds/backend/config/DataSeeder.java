...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedAchievements() {
        ...
        achievementRepository
                .save(new Achievement("STREAK_3", "Focus Momentum", "Maintain a 3-day training streak", "flame", 100));
        achievementRepository
                .save(new Achievement("STREAK_7", "Neuro-Discipline", "Maintain a 7-day training streak", "zap", 250));
        achievementRepository.save(new Achievement("LEVEL_5", "Synaptic Surge", "Reach Player Level 5", "star", 150));
